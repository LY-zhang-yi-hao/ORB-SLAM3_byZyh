...
def main():
    ...
    #! 文件路径
    f_file = "/home/zyh/Desktop/ORB-SLAM3_byZyh/f_custom_dataset_name.txt"
    kf_file = "/home/zyh/Desktop/ORB-SLAM3_byZyh/kf_custom_dataset_name.txt"
    ...
    try:
        ...
        import shutil
        # 仅使用文件名而不是完整路径
        f_file_name = os.path.basename(f_file)
        kf_file_name = os.path.basename(kf_file)
        shutil.copy2(f_file, os.path.join(data_dir, f_file_name))
        shutil.copy2(kf_file, os.path.join(data_dir, kf_file_name))
